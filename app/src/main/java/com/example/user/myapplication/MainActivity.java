...
public class MainActivity extends AppCompatActivity {
    ...
    Data[] tranaData = new Data[4];
        for (int i = 0; i< tranaData.length; i++){
            tranaData[i] = new Data();
        }
        tranaData[0].name = "腳踏車";
        tranaData[1].name = "機車";
        tranaData[2].name = "汽車";
        tranaData[3].name = "巴士";
        tranaData[0].photo = R.drawable.trans1;
        tranaData[1].photo = R.drawable.trans2;
        tranaData[2].photo = R.drawable.trans3;
        tranaData[3].photo = R.drawable.trans4;

        myAdapter transAdapter = new myAdapter(tranaData,R.layout.trans_list);
